...
def main():
  ...
  if args.resume_from_model is None:
    nnue = M.NNUE(feature_set=feature_set, lambda_=args.lambda_, start_lambda_=args.start_lambda, end_lambda_=args.end_lambda, max_epoch=max_epoch, gamma=args.gamma, lr=args.lr)
  else:
